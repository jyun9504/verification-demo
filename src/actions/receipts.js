...
export const getReceipts = (payload) => (dispatch) => {
  return new Promise((resolve, reject) => {
    let res = [
      ...
      {id: 6, tax_id_num: '77815839', receipt_num: '12345679', hash: '0x08716236', updated_time: '2021-03-05 14:00:00', uploaded_by: 'a20210304', bank: 'AA銀行'},
      {id: 2, tax_id_num: '52153255', receipt_num: '87651234', hash: '0x70918635', updated_time: '2021-03-01 13:00:00', uploaded_by: 'b20210304', bank: 'BB銀行'},
    ]
    if (payload === 1) {
      res =  [
        {id: 1, tax_id_num: '77815838', receipt_num: '12345678', hash: '0x77815838', updated_time: '2021-03-01 12:00:00', uploaded_by: 'a20210304', bank: 'AA銀行'},
      ...
      res =  [
        {id: 6, tax_id_num: '52153255', receipt_num: '87651234', hash: '0x70918635', updated_time: '2021-03-01 13:00:00', uploaded_by: 'b20210304', bank: 'BB銀行'},
      ]
    }
